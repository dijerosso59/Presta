<?php
/* Smarty version 3.1.47, created on 2023-09-20 15:47:44
  from 'module:psfacetedsearchviewstempl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.47',
  'unifunc' => 'content_650af80067a218_44474790',
...
function content_650af80067a218_44474790 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, false);
if (count($_smarty_tpl->tpl_vars['displayedFacets']->value)) {?>
  <div id="search_filters">
    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1741857155650af800610bb6_16969869', 'facets_title');
?>


    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_378328970650af8006143e3_59410883', 'facets_clearall_button');
?>
...
?>
      <section class="facet clearfix">
        ...
        <!-- Ajout des champs minimum et maximum -->
        <input type="text" name="filter_min_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['facet']->value['id'], ENT_QUOTES, 'UTF-8');?>
" placeholder="Min" />
        <input type="text" name="filter_max_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['facet']->value['id'], ENT_QUOTES, 'UTF-8');?>
" placeholder="Max" />
...
" data-toggle="collapse" <?php if (!$_smarty_tpl->tpl_vars['_collapse']->value) {?>
        ...
        <?php if (in_array($_smarty_tpl->tpl_vars['facet']->value['widgetType'],array('radio','checkbox'))) {?>
          <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_760985289650af80062cb94_80608707', 'facet_item_other');
?>


        <?php } elseif ($_smarty_tpl->tpl_vars['facet']->value['widgetType'] == 'dropdown') {?>
          <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_2035928548650af80064fcb1_74717226', 'facet_item_dropdown');
?>


        <?php } elseif ($_smarty_tpl->tpl_vars['facet']->value['widgetType'] == 'slider') {?>
          <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_847651989650af8006694b8_48243722', 'facet_item_slider');
?>
...
/* {block 'facets_title'} */
class Block_1741857155650af800610bb6_16969869 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'facets_title' => 
  array (
    0 => 'Block_1741857155650af800610bb6_16969869',
  ),
);
...
class Block_378328970650af8006143e3_59410883 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'facets_clearall_button' => 
  array (
    0 => 'Block_378328970650af8006143e3_59410883',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
class Block_760985289650af80062cb94_80608707 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'facet_item_other' => 
  array (
    0 => 'Block_760985289650af80062cb94_80608707',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
">
                    <?php if ($_smarty_tpl->tpl_vars['facet']->value['multipleSelectionAllowed']) {?>
                      <span class="custom-checkbox">
                        <input id="facet_input_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_expand_id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter_key']->value, ENT_QUOTES, 'UTF-8');?>
...
"></span>
                        ...
                        <?php } else { ?>
                          <span <?php if (!$_smarty_tpl->tpl_vars['js_enabled']->value) {?> class="ps-shown-by-js" <?php }?>><i
...
" data-search-url="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['nextEncodedFacetsURL'], ENT_QUOTES, 'UTF-8');?>
"
                          type="radio" name="filter <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['facet']->value['label'], ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['filter']->value['active']) {?>checked<?php }?>>
                    ...
                    <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['nextEncodedFacetsURL'], ENT_QUOTES, 'UTF-8');?>
...
class Block_2035928548650af80064fcb1_74717226 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'facet_item_dropdown' => 
  array (
    0 => 'Block_2035928548650af80064fcb1_74717226',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
class Block_847651989650af8006694b8_48243722 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'facet_item_slider' => 
  array (
    0 => 'Block_847651989650af8006694b8_48243722',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
