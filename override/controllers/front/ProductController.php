...
class ProductControllerCore extends ProductPresentingFrontControllerCore
{
    ...
    public function init()
    {
        ...
        if ($id_product) {
            ...
            $productCategories = $this->product->getProductCategories($this->product->id);
            ...
            // var_dump($categoriesInfo);
            $productBrand = false;

            foreach ($categoriesInfo as $cat) {
                var_dump($cat);
            ...
            $productBrand ?  $this->setTemplate('catalog/product', [
                'entity' => 'product',
                'id' => $id_product,
            ]) : $this->setTemplate('catalog/product_custom', [
                'entity' => 'product',
                'id' => $id_product,
            ]);
        }
        ...
        if (!Validate::isLoadedObject($this->product)) {
             ...
             */
            $isAssociatedToProduct = (Tools::getValue('adtoken') == Tools::getAdminToken(
                'AdminProducts'
